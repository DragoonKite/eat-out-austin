...
const reviewData = [
  ...
  },
  {
    ...
    res_reviewed: 17,
    review_content:
      "Tucked away in west campus on an easily-missed second floor is Mushashino, a treasure of sushi in Austin, TX. Not as flashy as some of the more well known places in town this traditionally decorated nook has some of the best sliced fish in town. There are traditional pieces, classic small plates and a yakitori grill to tempt both the novice and expert sushi palate. If you happen to be lucky, you can catch a spectacular sunset from the wrap-around patio overlooking Pease Park. Be sure to make a reservation on busy nights so you're not left waiting while others enjoy sake and tasty bites.",
    review_approval: true,
  },
  {
    id: 18,
